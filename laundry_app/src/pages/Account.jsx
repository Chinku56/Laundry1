    ...
    <div className="account-container page-fade">
      {loading ? (
        ...
        <>
          ...
          <button className="Back1" onClick={() => navigate("/home")}>
            Back
          </button>
          ...
          <div className="section-container slide-up">
            <section className="section club-membership">
              ...
              <div className="membership-info">
                ...
                <p>
                  <strong>Email:</strong> {defaultEmail}
                </p>
                <p>
                  <strong>Address:</strong> {defaultAddress}
                </p>
                <p>
                  <strong>Club Ultimate:</strong> {defaultClubMembership}
                </p>
                <p>
                  <strong>Expiry Date:</strong> {defaultExpiryDate}
                </p>
              </div>
            </section>
          </div>
            ...
            <section className="section address-book">
              ...
              {selectedCity && selectedArea && pincode && (
                <div className="selected-address">
                  <p>
                    <strong>📍 Location:</strong> {selectedArea}, {selectedCity}
                  </p>
                  <p>
          ...
          <div className="section-container slide-up">
            <section className="section service-history">
              ...
              <button className="Back2" onClick={() => navigate("/Pastorder")}>
                View Past Orders
              </button>
            </section>
          </div>
          ...
          {addressRemoved && (
            <div className="toast-success slide-in">📍 Address removed!</div>
          )}
        </>
      )}
    </div>
