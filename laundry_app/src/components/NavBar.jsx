...
//                <Link to="/Offers" ><NotificationsNoneIcon
//                 style={{
//                   fontSize: "150%",
//                   cursor: "pointer",
//                   marginLeft: "400%",
        ...
        <div ref={menuRef} className={`navbar__menu ${menuOpen ? "open" : ""}`}>
          <ul >
            ...
            >
              ...
              {servicesOpen && (
                <ul className="dropdown">
                  <li><Link to="/washfoldprices">WASH AND FOLD</Link></li>
                  <li><Link to="/washiron">WASH AND IRON</Link></li>
                  <li><Link to="/steamiron">STEAM IRON</Link></li>
                  <li><Link to="/dryclean">DRY CLEAN</Link></li>
                </ul>
              )}
            </li>
            <li><Link to="Servicehours">SERVICE HOURS</Link></li>
            <li><Link to="Subscriptions">CLUB ULTIMATE</Link></li>
            <li><Link to="Subscriptions">PIKUP SCHEDULER</Link></li>
            <li>
              <Link to="/cart">
            ...
            <li style={{ position: "relative" }}>
              <Link to="/Offers">
                <NotificationsNoneIcon style={{ fontSize: "24px", color: "#000" }} />
                {total > 0 && (
                  <span style={{
                    position: "absolute",
                    top: "0",
            ...
            <li style={{ position: "relative" }}>
              <Link to="/Accountpage">
                <AccountCircleIcon style={{ fontSize: "24px", color: "#000" }} />
                {total > 0 && (
                  <span style={{
                    position: "absolute",
                    top: "0",
            ...
            <li className="mobile-only">
              <Link to="" className="btn btn--filled">SIGN UP</Link>
            </li>
          </ul>
        </div>
