  ...
  return (
    ...
    <section className="services">
      ...
      <p className="services__description">
        ...
        it’s about laundry, it’s about time you stopped doing it yourself. Leave
        it to us.
      </p>
          ...
          >
            <div className="card__inner">
              ...
              <div className="card__back">
                <p>
                  <strong>{service.title}</strong> service is quick, affordable,
                  and handled with care. <br />
                  Enjoy doorstep pickup and delivery for all your laundry needs.
                </p>
              </div>
            </div>
          </div>
